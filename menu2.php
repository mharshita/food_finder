...
<form action="addtoDB.php" method="POST"><strong><input type="submit" name="add2a" class="button button-accent button-small" value="+"></strong></form>
...
<div class="column content">
<form action="addtoDB.php" method="POST"><strong><input type="submit" name="add2b" class="button button-accent button-small" value="+"></strong></form>
<h1 class="card-head"><strong> <?php echo $row['item'];?></strong> </h1>
...
<div class="column content">
<form action="addtoDB.php" method="POST"><strong><input type="submit" name="add2c" class="button button-accent button-small" value="+"></strong></form>
<h1 class="card-head"> <strong><?php echo $row['item'];?></strong> </h1>
...
<div class="column content">
<form action="addtoDB.php" method="POST"><strong><input type="submit" name="add2d" class="button button-accent button-small" value="+"></strong></form>
<h1 class="card-head"><strong> <?php echo $row['item'];?></strong> </h1>
